...
def train(eventlog_dir, petrinet_dir, input_dim=64, hidden_dim=16, dense_hidden_dim=32, output_dim=1, 
    ...
    for epoch in range(epochs):
        ...
        for eventlog_batch, petrinet_batch in zip(batch_loader.batch_eventlog_loader(eventlog_dir, batch_size),
                                                  batch_loader.batch_petrinet_loader(petrinet_dir, batch_size)):
            pyg_graphs = []
