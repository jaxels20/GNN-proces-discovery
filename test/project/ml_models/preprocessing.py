...
class GraphBuilder:
  ...
  def connectTraceGraphToPetrinet(self):
    ...
    if 'is_place' not in self.mPetrinetGraph.ndata:
      self.mPetrinetGraph.ndata['is_place'] = th.zeros(self.mPetrinetGraph.number_of_nodes(), dtype=th.int64).reshape(self.mPetrinetGraph.number_of_nodes(), 1)
