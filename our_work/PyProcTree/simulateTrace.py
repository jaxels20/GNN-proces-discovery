# -*- coding: utf-8 -*-
"""
Created on Thu May 12 09:57:03 2016

@author: lucp8356

Simulates a single trace given a newick tree

INPUT:
    newick tree string

OUTPUT:
    trace as a list of events
"""
...
class TraceSimulator():
    ...
    def __init__(self,newick_tree, record_timestamps):
        ...
        #run the instance
        self.run()
        self.case.trace = self.returnTrace()
