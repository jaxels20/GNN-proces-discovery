...
def export_petri_tree(petrinet, marking, final_marking=None, export_prom5=False, parameters=None):
    ...
    Parameters
    ----------
    petrinet: :class:`pm4py.entities.petri_net.obj.PetriNet`
        Petri net
    marking: :class:`pm4py.entities.petri_net.obj.Marking`
        Marking
    final_marking: :class:`pm4py.entities.petri_net.obj.Marking`
