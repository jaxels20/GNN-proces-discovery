from gnn_miner.data_handling.t_component import compute_t_components
from gnn_miner.data_handling.s_component import compute_s_components
from gnn_miner.data_handling.drawio import DrawIO
...
class PetrinetHandler:
  ...
  def get_pm4py_s_coverable(self):
    ...
    from pm4py.algo.analysis.woflan.algorithm import woflan
    from gnn_miner.data_handling.woflan import step_1_, step_2_, step_3_
